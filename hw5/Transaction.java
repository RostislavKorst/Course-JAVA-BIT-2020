...
public class Transaction implements Comparable<Transaction> {
    ...
    public Transaction(double amount, DebitCard originator, DebitCard beneficiary, boolean executed, boolean rolledBack) {
        this.id = counter++;
        this.amount = amount;
    ...
    public Transaction(long id, double amount, DebitCard originator, DebitCard beneficiary, boolean executed,
                       boolean rolledBack) {
        this.id = id;
        this.amount = amount;
        this.originator = originator;
