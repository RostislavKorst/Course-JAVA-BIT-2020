...
public class AnalyticsManagerTest {
    ...
    private DebitCard mainAccount;
    private DebitCard beneficiary1;
    private DebitCard beneficiary2;
    private DebitCard beneficiary3;
    private DebitCard beneficiary4;
    ...
    public void accountsRangeFrom() {
        //when
        executeTransactionsWithDebitCards();
        List<Account> expectedAccounts = new ArrayList<>(List.of(debitCard1, debitCard3,
                debitCard4, debitCard5, debitCard6));
        List<Account> actualAccounts = analyticsManager.accountsRangeFrom(List.of(debitCard5, debitCard4,
                debitCard3, debitCard6, debitCard1,
                debitCard2), debitCard1, Comparator.comparingDouble(Account::currentBalance));
        //then
        assertEquals(expectedAccounts, actualAccounts);
    }

    private void executeTransactionsWithDebitCards() {
        debitCard1.addCash(2000);
